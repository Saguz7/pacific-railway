    ...
    getPPSDetails(lon: any,lat: any) {
      ...
      content_array.push(
        ...
        { columns: [
            ...
            { width: '25%', text: lat, fontSize: 9,margin: [0, 0, 0, 0]},
            { width: '25%', text: 'Lon:',alignment: 'right', fontSize: 10,bold: true, margin: [0, 0, 0, 0]},
            { width: '25%', text: lon, fontSize: 9,margin: [0, 0, 0, 0]},
          ...
          { columns: [
            ...
            { columns: [
              ...
              { columns: [
                ...
                { columns: [
                     {  width: '25%',  text: 'Hash Key:' , fontSize: 10,bold: true, margin: [0, 0, 0, 0]},
                     {  width: '75%',  text: properties.hash_key, fontSize: 9 , margin: [0, 0, 0, 0]}
